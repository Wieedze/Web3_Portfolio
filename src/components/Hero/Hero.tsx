...
export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center min-h-[70vh] px-6 text-center">
      ...
      >
        <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-white/10 bg-white/5 text-sm text-white/70 backdrop-blur-sm">
        ...
        <div className="flex gap-5 mt-6">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl border border-white/10 bg-white/5 text-base text-white/80 hover:bg-white/10 hover:border-white/20 transition-all backdrop-blur-sm"
          >
