...
export default function Footer() {
  return (
    <section className="w-full max-w-3xl px-8 pb-16 pt-8 flex flex-col items-center">
      <motion.div
      ...
      <footer className="mt-16 text-sm text-white/20">
        Built for EthCC[9] — Cannes 2026
      </footer>
    </section>
  )
}
